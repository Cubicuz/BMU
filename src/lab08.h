#ifndef LAB08_H_INCLUDED
#define LAB08_H_INCLUDED
...
void lab_08_color_blobs(void){
    ...
    Mat hsv, imgRed, imgGreen, imgBlue, imgBlack;
	Mat screenShot;
    bool firstRun = true;
	...
	for(;;){
		...
		// filter colors
		inRange(hsv, Scalar(0, 120, 70), Scalar(40, 255, 255), imgRed);
		inRange(hsv, Scalar(80, 120, 70), Scalar(120, 255, 255), imgBlue);
		inRange(hsv, Scalar(40, 120, 70), Scalar(80, 255, 255), imgGreen);
		inRange(hsv, Scalar(0, 0, 0), Scalar(180, 120, 90), imgBlack);
